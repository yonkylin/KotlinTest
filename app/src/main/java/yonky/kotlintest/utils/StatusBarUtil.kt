...
import com.shuyu.gsyvideoplayer.utils.CommonUtil.getStatusBarHeight
...
class StatusBarUtil{
    companion object {
        ...
        fun darkMode(acitivity:Activity){
            darkMode(acitivity.window, DEFAULT_COLOR, DEFAULT_ALPHA)
        }
